...
class Lemmatizer():
    ...
    with open(os.path.join(os.getcwd() + "\\ulster\\lemmatizer\\forms.json"), encoding='utf-8') as f, \
	open(os.path.join(os.getcwd() + "\\ulster\\lemmatizer\\word_probs.json"), encoding="utf-8") as f1, \
	open(os.path.join(os.getcwd() + "\\ulster\\lemmatizer\\lemma_probs.json"), encoding="utf-8") as f2:
    ...
    def update_wordprobs():
        ...
        with open("word_probs.json", "w", encoding = "utf-8") as f2:
    ...
    def update_lemmaprobs():
        ...
        with open("lemma_probs.json", "w", encoding="utf-8") as f2:
